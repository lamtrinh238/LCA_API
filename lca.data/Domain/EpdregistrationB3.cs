...
{
    [Table("EPDRegistrationB3")]
    public partial class EpdregistrationB3
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDB3ID")]
        public int Epdb3id { get; set; }
        [Column("EPDB3Name")]
        [StringLength(150)]
        public string Epdb3name { get; set; }
        [Column("EPDB3Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdb3quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDB3Unit")]
        [StringLength(50)]
        public string Epdb3unit { get; set; }
        ...
        [InverseProperty("EpdregistrationB3s")]
