...
{
    [Table("EPDRegistrationB7")]
    public partial class EpdregistrationB7
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDB7ID")]
        public int Epdb7id { get; set; }
        [Column("EPDB7Name")]
        [StringLength(150)]
        public string Epdb7name { get; set; }
        [Column("EPDB7Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdb7quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDB7Unit")]
        [StringLength(50)]
        public string Epdb7unit { get; set; }
        ...
        [InverseProperty("EpdregistrationB7s")]
