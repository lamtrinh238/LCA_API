...
{
    [Table("EPDRegistrationC1")]
    public partial class EpdregistrationC1
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDC1ID")]
        public int Epdc1id { get; set; }
        [Column("EPDC1Name")]
        [StringLength(150)]
        public string Epdc1name { get; set; }
        [Column("EPDC1Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdc1quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDC1Unit")]
        [StringLength(50)]
        public string Epdc1unit { get; set; }
        ...
        [InverseProperty("EpdregistrationC1s")]
