...
{
    [Table("EPDProjectFases")]
    public partial class EpdprojectFase
    {
        [Key]
        [Column("ID")]
        ...
        [Column("Unit_calcT", TypeName = "decimal(27, 12)")]
        ...
        [InverseProperty(nameof(EpdprojectHeading.EpdprojectFases))]
