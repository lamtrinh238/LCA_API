...
{
    [Table("EPDRegistrationB5")]
    public partial class EpdregistrationB5
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDB5ID")]
        public int Epdb5id { get; set; }
        [Column("EPDB5Name")]
        [StringLength(150)]
        public string Epdb5name { get; set; }
        [Column("EPDB5Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdb5quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDB5Unit")]
        [StringLength(50)]
        public string Epdb5unit { get; set; }
        ...
        [InverseProperty("EpdregistrationB5s")]
