...
{
    [Table("EPDRegistrationC3")]
    public partial class EpdregistrationC3
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDC3ID")]
        public int Epdc3id { get; set; }
        [Column("EPDC3Name")]
        [StringLength(150)]
        public string Epdc3name { get; set; }
        [Column("EPDC3Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdc3quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDC3Unit")]
        [StringLength(50)]
        public string Epdc3unit { get; set; }
        ...
        [InverseProperty("EpdregistrationC3s")]
