...
{
    [Table("EPDRegistrationB6")]
    public partial class EpdregistrationB6
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDB6ID")]
        public int Epdb6id { get; set; }
        [Column("EPDB6Name")]
        [StringLength(150)]
        public string Epdb6name { get; set; }
        [Column("EPDB6Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epdb6quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDB6Unit")]
        [StringLength(50)]
        public string Epdb6unit { get; set; }
        ...
        [InverseProperty("EpdregistrationB6s")]
