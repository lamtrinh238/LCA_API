...
namespace LCA.Data.Domain
{
    ...
    public partial class EpdprojectHeading
    {
        ...
        [InverseProperty(nameof(Company.EpdprojectHeadings))]
        public virtual Company Com { get; set; }
        [InverseProperty(nameof(EpddataSetDocumentationRegistrationsProject.Epdheading))]
        ...
        [InverseProperty(nameof(EpdprojectFase.Epdheading))]
