...
{
    [Keyless]
    public partial class EpdcalculationA42
    {
        [Column("ID")]
        ...
        [Column("f_e_cons", TypeName = "decimal(38, 8)")]
        public decimal? FECons { get; set; }
        [Column("FECons", TypeName = "decimal(38, 9)")]
        public decimal? Fecons1 { get; set; }
        [StringLength(500)]
