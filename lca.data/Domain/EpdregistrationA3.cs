...
{
    [Table("EPDRegistrationA3")]
    public partial class EpdregistrationA3
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDA3Quantity", TypeName = "decimal(21, 12)")]
        ...
        [Column("Unit_calc", TypeName = "decimal(21, 12)")]
        ...
        [InverseProperty("EpdregistrationA3s")]
