...
{
    [Table("EPDRegistrationA5")]
    public partial class EpdregistrationA5
    {
        [Key]
        [Column("ID")]
        ...
        [Column("EPDA5ID")]
        public int Epda5id { get; set; }
        [Column("EPDA5Name")]
        [StringLength(150)]
        public string Epda5name { get; set; }
        [Column("EPDA5Quantity", TypeName = "decimal(18, 9)")]
        public decimal? Epda5quantity { get; set; }
        [StringLength(250)]
        public string Comments { get; set; }
        [Column("EPDA5Unit")]
        [StringLength(50)]
        public string Epda5unit { get; set; }
        ...
        [InverseProperty("EpdregistrationA5s")]
