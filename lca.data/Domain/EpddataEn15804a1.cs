...
{
    [Table("EPDDataEN15804A1")]
    public partial class EpddataEn15804a1
    {
        [Key]
        [Column("ID")]
        ...
        [InverseProperty(nameof(EpddataSetDocumentation.EpddataEn15804a1s))]
        public virtual EpddataSetDocumentation ParentDataSet { get; set; }
    }
}
