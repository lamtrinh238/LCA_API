...
{
    [Table("EPDDataEN15804A2RegistrationsProjects")]
    public partial class EpddataEn15804a2registrationsProject
    {
        [Key]
        [Column("ID")]
        ...
        [InverseProperty(nameof(EpddataSetDocumentationRegistrationsProject.EpddataEn15804a2registrationsProjects))]
